...
%
Along with equilibrium statistics, the ability of MD to reproduce the bilayer dynamics equally crucial for an accurate picture of membrane function %in addition to equilibrium measurements are. 
...
easily quantifiable from atomistic MD simulations.
The
...
\todo{Laske bilayerissa $S_\mathrm{CH}$ korrelaatiot yksittaisille lipidelle vs $\tau_\mathrm e$.}
