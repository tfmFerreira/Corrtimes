...
In the following, we discuss the internal dynamics of POPC lipids in
six different MD force fields (Table~\ref{tab:standr}).
%Berger, Slipids, MacRog, Lipid14, ECC, and CHARMM36.
One should keep in mind that none of these six
...
the structural ensemble occurring in reality---these simulations are not a true computational microscope.
%
Consequently, the
...
$\tau_\mathrm{e}$---as indicated by the CHARMM36 simulations at different temperatures---such that
any overestimation of $\tau_\mathrm{e}$ by MD would get worse, were the simulations done at the experimental 298\,K.
