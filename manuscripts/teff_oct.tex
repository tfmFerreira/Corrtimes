...
\caption{
(A) Zoom on $\tau_\mathrm e$ (left panel) and $R_1$ (right).
(B) Cumulative $R_1$ of $\gamma$ (top panel), $\beta$ (middle), and $\alpha$ (bottom).
(C) Prefactor weighs $\alpha_i$ from Eq.~\eqref{eq:weights} of $\gamma$ (top panel), $\beta$ (middle), and $\alpha$ (bottom).
...
\subsection*{On the importance of $S_\mathrm{CH}$.}
We note that while some models, like CHARMM36, seem to provide reasonable conformational dynamics, none of them produces a set of order parameters in full agreement with the experiments~\cite{botan15}.
%
...
\subsection*{Changing conditions.}
