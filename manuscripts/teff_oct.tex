...
The best overall performance is obtained from CHARMM36 and Slipids force fields, although in Slipids dynamics exhibits a qualitatively wrong, decreasing, trend from $\mathrm g_{3}$ to $\mathrm g_{1}$. \todo{Not extremely clear, though; would be good to know the errors to make this claim.}
